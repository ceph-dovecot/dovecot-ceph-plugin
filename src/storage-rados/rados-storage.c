...
static void rados_storage_get_list_settings(const struct mail_namespace *ns ATTR_UNUSED,
...
static struct mailbox *rados_mailbox_alloc(struct mail_storage *storage, struct mailbox_list *list, const char *vname,
...
static int rados_mailbox_get_metadata(struct mailbox *box, enum mailbox_metadata_items items,
...
struct mail_storage rados_storage = {
    ...
    .v = {
        NULL, rados_storage_alloc, NULL, index_storage_destroy, NULL, rados_storage_get_list_settings, NULL,
        rados_mailbox_alloc, NULL, NULL,
    }};

struct mailbox rados_mailbox = {.v = {index_storage_is_readonly,
